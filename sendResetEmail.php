...
$mail->addAddress($verifyEmail, 'Reset password');
...
$mail->msgHTML(preg_replace("/\{\{message\}\}/", "<a href=\"{$baseurl}reset/{$verifyHash}\">Click Here!</a> or visit this link {$baseurl}reset/{$verifyHash}", file_get_contents('lib/email_contents.html')));
