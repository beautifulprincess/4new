            ...
            return this.each(function () {
                ...
                if (!_showFlag) {
                    ...
                    $.each(_countries, function (i, country) {
                        var html = '<option value="' + country[_codeProp] + '"';
                        if (country[_codeProp] == "" || country[_codeProp] == -1) html += ' disabled';
